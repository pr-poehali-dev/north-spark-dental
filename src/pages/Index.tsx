    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-12">
              {[
                ...
                <div key={index} className="flex gap-8 items-start">
                  <div className="hidden md:flex w-16 h-16 bg-primary rounded-full items-center justify-center text-white font-bold text-lg flex-shrink-0 relative z-10">
                    {item.step}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Card className="border-2 border-primary bg-blue-50/50">
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start mb-2">
                      <div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-br from-primary to-blue-600 rounded-3xl p-8 md:p-12 text-white">
            <div className="max-w-2xl mx-auto text-center space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 pt-6">
                <Input 
                  ...
                  required
                  className="bg-white/10 border-white/20 text-white placeholder:text-blue-200 h-14"
                />
                <Input 
                  type="tel" 
                  placeholder="Телефон" 
